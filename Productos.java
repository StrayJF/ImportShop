...
public class Productos extends baseWindow{
    ...
    public void panelComplementario(){
        ...
        TitledBorder tituloDelBorde = BorderFactory.createTitledBorder("Registro de Productos"); //Borde que funcione como marco y con un titulo
