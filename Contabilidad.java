...
public class Contabilidad extends baseWindow{
    ...
    public void panelComplementario(){
        ...
        TitledBorder tituloDelBorde = BorderFactory.createTitledBorder("Sistema Contable"); //Borde que funcione como marco y con un titulo
